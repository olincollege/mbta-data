...
```
```{r}
plot(station_race16$income,station_race16$norm_entries,
     xlab = 'median income',
     ylab = 'normalized gated entries',
     main = 'Scatter Plot of the normalized gated entries vs median income'
     )
...
station_populations_16_22$diff_norm_entry <- norm_station_populations22$norm_entries - norm_station_populations16$norm_entries
diff_norm_station_entry <- ggplot() +
  ...
  scale_fill_gradient(low = "red", high = "yellow", na.value = NA, name = "Additional Riders in 2022")
