...
## Correlate stations with blocks
```{r}
...
ggplot(filtered_data_black) +
  ...
  geom_line(aes(percent, predict(lm_entry_black_filtered, newdata = filtered_data_black))) +
...
```
# Mapping Census Data with Station Locations
...
boston_race_22 %>%
  ...
  theme_void() +
  scale_fill_viridis_c() +
  labs(fill = "% of population", subtitle = "2022 census", title = "MBTA Station Locations")
